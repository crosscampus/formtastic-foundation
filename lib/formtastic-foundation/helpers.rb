module FormtasticFoundation
  module Helpers
    autoload :ActionHelper,  'formtastic-foundation/helpers/action_helper'
    autoload :ActionsHelper, 'formtastic-foundation/helpers/actions_helper'
    autoload :ErrorsHelper, 'formtastic-foundation/helpers/errors_helper'
    ...
    # autoload :Reflection, 'formtastic/helpers/reflection'  end
  end
end
